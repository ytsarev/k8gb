...
### Exercise 1: Analyze Log Output (Beginner)
...
### Exercise 2: Add Error Logging (Intermediate)
...
### Exercise 3: Add Metrics (Advanced)
...
### Exercise 4: Log Context Propagation (Advanced)
